...
export const teamResponses: FallbackResponse[] = [
  {
    text: "Our leadership team brings deep expertise across engineering, strategy, and growth: Muhammad Aafaq (Founder & Lead Engineer), Muhammad Ahsan Ali (Co-Founder & Director), and Waheeb Ullah (Director of Growth). Each leader drives excellence in their domain.",
    quickReplies: [
